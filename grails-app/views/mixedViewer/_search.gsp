<div class="search">
  <g:form method="get" name="search">
    ...
    <g:select id="search-period" name="period" from="${command.periodCandidates}" value="${command.period}" valueMessagePrefix="mixedViewer.search.period"/>
    ...
    <g:select id="search-channel" name="channel" from="${command.channelCandidates}" value="${command.channel}" valueMessagePrefix="mixedViewer.search.channel"/>
    ...
    <span class="searchItem" title="${message(code: 'mixedViewer.search.type.tooltips')}"><g:checkBox id="search-type" name="type" value="all" checked="${command.type == 'all'}"/><label for="search-type" id="search-type-label"><g:message code="mixedViewer.search.type.all"/></label></span>
