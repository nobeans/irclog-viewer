  ...
  <g:form method="get" name="search">
    <label for="search-period"><g:message code="mixedViewer.search.period" />:</label>
      ...
      <span id="period-today-select" ${(criterion?.period == 'today') ? '' : 'style="display:none"'}>
        ...
        <img class="button" id="period-today-time-button" src="${createLinkTo(dir:'images', file:'fromClock.png')}" title="${message(code:'mixedViewer.search.period.today.tooltips')}" alt="Clock" />
      </span>
      <span id="period-oneday-select" ${(criterion?.period == 'oneday') ? '' : 'style="display:none"'}>
        ...
        <img class="button" id="period-oneday-date-button" src="${createLinkTo(dir:'images', file:'calendar.png')}" title="${message(code:'mixedViewer.search.period.oneday.tooltips')}" alt="Calendar" />
    ...
    <span class="searchItem" title="${message(code:'mixedViewer.search.clear.button.tooltips')}"><input id="search-clear" class="image" type="image" src="${createLinkTo(dir:'images',file:'searchClear.png')}" name="_action_clearCriterion" alt="Clear" /><label for="search-clear" id="search-clear-label"><g:message code="${message(code:'mixedViewer.search.clear.button')}" /></label></span>
