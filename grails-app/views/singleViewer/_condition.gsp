<div class="condition caption">
  ...
  <span id="condition-date">
    <span data-bind="if: showBeforeDate()"><g:img class="button" file="singleBefore.png" data-bind="event: {click: toBeforeDate}"/></span>
    <span id="currentDate" data-bind="text: currentDate">${params.date}</span>
    <span data-bind="if: showAfterDate()"><g:img class="button" file="singleAfter.png" data-bind="event: {click: toAfterDate}"/></span>
    <span data-bind="if: showLatestDate()"><g:img class="button" file="singleLatest.png" data-bind="event: {click: toLatestDate}"/></span>
