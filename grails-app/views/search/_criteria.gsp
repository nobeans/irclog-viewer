<div class="search">
  <g:form method="get" name="search">
    ...
    <g:select id="search-period" name="period" from="${periodCandidates}" value="${command.period}" valueMessagePrefix="search.criteria.period"/>
    ...
    <g:select id="search-channel" name="channel" from="${channelCandidates}" value="${command.channel}" valueMessagePrefix="search.criteria.channel"/>
