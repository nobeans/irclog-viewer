(function (jQuery) {
    ...
    var bundle = i18n[lang] || i18n.default;
    console.log("bundle:", bundle);

    jQuery.format = (function () {
        function strDddd(value) {
            return bundle.dddd[parseInt(value, 10)] || value;
        }

        function strDdd(value) {
            return bundle.ddd[parseInt(value, 10)] || value;
        }

        function strMonth(value) {
            var monthArrayIndex = parseInt(value, 10) - 1;
            return bundle.MMM[monthArrayIndex] || value;
        }

        function strLongMonth(value) {
            var monthArrayIndex = parseInt(value, 10) - 1;
            return bundle.MMMM[monthArrayIndex] || value;
        }
            ...
            date: function (value, format) {
                ...
                try {
                    ...
                    for (var i = 0; i < format.length; i++) {
                        ...
                        switch (pattern) {
                            case 'dddd':
                                retValue += strDddd(dayOfWeek);
                                pattern = '';
                            case 'ddd':
                                retValue += strDdd(dayOfWeek);
                                pattern = '';
                                break;
                            case 'dd':
